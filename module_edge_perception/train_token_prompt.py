...
def parse_args():
    parser = argparse.ArgumentParser(description="Train prompts for token-aware MV-VIT.")
    ...
    parser.add_argument("--save-path", type=str, default="./checkpoints/prompt_token_aware_best.pth")
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        for images, labels, drift_types, _severities, _struct_drifts in loader:
        ...
        if epoch_acc >= best_acc:
            ...
            print(f"已保存最佳 Prompt 权重至: {args.save_path}")

    print(f"Prompt 训练完成，最佳训练准确率: {best_acc:.4%}")
