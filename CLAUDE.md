...
| 业务保持率（四档） | 模拟版（PR#31）：99.83-99.96%；**真模型全链路（2026-08-11）：89.67-89.95%，差 0.05-0.33% 未达 90%**，归因：248 失败时隙全部 conf<0.8 被 acc_floor 打掉，u=1 adapter 分支准确率 87.89% < u=0 的 93.10%（详见 docs/多节点冲突仲裁测试结果_20260811.md） | ⚠️ 待补跑达标 |
